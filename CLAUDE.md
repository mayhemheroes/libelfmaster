...
## Run Information
- Mayhem Run: mayhemheroes/libelfmaster/stripx/4
- Git Commit: 9d3c01263d75ee1ac2965f49adca8ebfc40ee20d
- Original Image: ghcr.io/mayhemheroes/libelfmaster:master
- Target Executable: Not specified
- CI URL: https://github.com:443/mayhemheroes/libelfmaster//actions/runs/4297041411
...
- Source code: `/rlenv/source/libelfmaster/`
...
- `COPY . /rlenv/source/libelfmaster/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/libelfmaster/`
...
### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/libelfmaster/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/libelfmaster/fuzz
...
- Source copy: `COPY . /rlenv/source/libelfmaster/`
...
- Working directory: `cd /rlenv/source/libelfmaster/`
- No network access
